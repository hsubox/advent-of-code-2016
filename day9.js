...
function decompressedLengthPart1(startIndex, segmentLength) {
  ...
  while (i < startIndex + segmentLength) {
    ...
    i++;
    if (ch == "(") {
      var indexOfX = input.indexOf('x', i);
      var indexOfY = input.indexOf(')', i);
      var subsegmentLength = Number(input.substring(i, indexOfX));
      var repeatCount = Number(input.substring(indexOfX + 1, indexOfY));
      i = indexOfY + 1;
